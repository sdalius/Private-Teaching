...
namespace Private_teaching.Migrations
{
    ...
    [Migration("20220523133353_OneToManyRelationToBookedTimes6")]
    partial class OneToManyRelationToBookedTimes6
    {
            ...
            modelBuilder.Entity("Private_teaching.Entities.BookedTimes", b =>
                {
                    ...
                    b.HasKey("booking_Id", "Listed_Subject_Id");
            ...
            modelBuilder.Entity("Private_teaching.Entities.BookedTimes", b =>
                {
                    ...
                    b.HasOne("Private_teaching.Entities.Booking", "Booking")
                        ...
                        .HasForeignKey("booking_Id", "Listed_Subject_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
