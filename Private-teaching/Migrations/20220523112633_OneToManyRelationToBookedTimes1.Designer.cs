...
namespace Private_teaching.Migrations
{
    ...
    [Migration("20220523112633_OneToManyRelationToBookedTimes1")]
    partial class OneToManyRelationToBookedTimes1
    {
            ...
            modelBuilder.Entity("Private_teaching.Entities.BookedTimes", b =>
                {
                    ...
                    b.Property<int>("booked_times_id")
                        .HasColumnType("integer")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("Private_teaching.Entities.BookedTimes", b =>
                {
                    ...
                    b.HasOne("Private_teaching.Entities.Booking", null)
                        .WithMany("BookedTimes")
                        .HasForeignKey("booked_times_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
