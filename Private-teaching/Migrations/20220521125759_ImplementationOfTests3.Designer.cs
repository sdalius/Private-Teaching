...
namespace Private_teaching.Migrations
{
    ...
    [Migration("20220521125759_ImplementationOfTests3")]
    partial class ImplementationOfTests3
    {
            ...
            modelBuilder.Entity("Private_teaching.Entities.Questionnaire.QuestionAnswers", b =>
                {
                    ...
                    b.Property<int>("QuestionOptionsquestion_id")
                        .HasColumnType("integer");

                    b.Property<int>("QuestionOptionsquestion_option_id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("QuestionOptionsquestion_option_id", "QuestionOptionsquestion_id");
            ...
            modelBuilder.Entity("Private_teaching.Entities.Questionnaire.QuestionOptions", b =>
                {
                    ...
                    b.HasKey("question_option_id", "question_id");
            ...
            modelBuilder.Entity("Private_teaching.Entities.Questionnaire.QuestionAnswers", b =>
                {
                    ...
                    b.HasOne("Private_teaching.Entities.Questionnaire.QuestionOptions", "QuestionOptions")
                        .WithMany()
                        .HasForeignKey("QuestionOptionsquestion_option_id", "QuestionOptionsquestion_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
