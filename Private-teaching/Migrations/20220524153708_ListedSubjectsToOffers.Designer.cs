...
namespace Private_teaching.Migrations
{
    ...
    [Migration("20220524153708_ListedSubjectsToOffers")]
    partial class ListedSubjectsToOffers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Private_teaching.Entities.Offers", b =>
                {
                    b.Property<int>("Offer_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Private_teaching.Entities.BookedTimes", b =>
                {
                    ...
                    b.HasOne("Private_teaching.Entities.Offers", "Offers")
                        .WithMany()
                        .HasForeignKey("Offer_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Private_teaching.Entities.Booking", "Booking")
                        .WithMany("BookedTimes")
                        .HasForeignKey("booking_Id", "Offer_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
